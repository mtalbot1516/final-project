...
// Accessing the Realestate GeoJSON URL
let realestateData = "https://raw.githubusercontent.com/mtalbot1516/final-project/main/reformatted_house_value.json";
// Grabbing our GeoJSON data.
d3.json(realestateData).then(function(data) {
   
  // This function returns the style data for each of the cities we plot on
  // the map. We pass the value of the property into two separate functions
  // to calculate the color.
  function styleInfo(house_value) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: getColor(house_value),
      color: "#000000",
      stroke: true,
      weight: 0.5
    };
  ...
  // This function determines the color of the marker based on the house_value determination.
  function getColor(house_value) {
    if (house_value = "bad_value") {
      return "#CB2B3E";
    }
    if (house_value = "good_value") {
      return "#2AAD27";
    }
  }
...
//    layer.bindPopup(feature.properties.realestateData.city)
//    // + ", " + city.state + "</h2> <hr> <h3>BB: " + city.BB + " " +  "</h3> <hr> <h3>Street " + city.street  + "</hr3>" + "<hr> <h3>Price: $" + city.price.toLocaleString() + "</h3>")
// }
// }).addTo(map);
...
let cityData = realestateData;


// Loop through the cities array and create one marker for each city.
realestateData.forEach(function(city) {
  console.log(city)
...
//  //.bindPopup("<h2>" + city.city + ", " + city.state + "</h2> <hr> <h3>Street " + city.street  + "</hr3>" + "<hr> <h4>Price: $" + city.price.toLocaleString() + "</h4>")
   city.bindPopup("<h2>" + city.city + ", " + city.state + "</h2> <hr> <h3>BB: " + city.BB + " " +  "</h3> <hr> <h3>Street " + city.street  + "</hr3>" + "<hr> <h3>Price: $" + city.price.toLocaleString() + "</h3>")}
